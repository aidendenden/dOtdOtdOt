...
public class UIController : MonoBehaviour {
	...
	void GetScriptedParent ()		// This function gets the selected options of the scripted (grand)parent of the selected object and affects the selected object accordingly
	{
		...
		if (other.gameObject.GetComponent<Move>() == false && other.gameObject.GetComponent<MoveParent>() == false && other.gameObject.GetComponent<MoveOther>() == false && other.gameObject.GetComponent<Resize>() == false && other.gameObject.GetComponent<ResizeParent>() == false && other.gameObject.GetComponent<ResizeOther>() == false && other.gameObject.GetComponent<Rotate>() == false && other.gameObject.GetComponent<BringToFront>() == false && other.gameObject.GetComponent<Canvas>() == false)
		{
			...
			while (otherParent.gameObject.GetComponent<Move>() == false && otherParent.gameObject.GetComponent<MoveParent>() == false && otherParent.gameObject.GetComponent<MoveOther>() == false && otherParent.gameObject.GetComponent<Resize>() == false && otherParent.gameObject.GetComponent<ResizeParent>() == false && otherParent.gameObject.GetComponent<ResizeOther>() == false && otherParent.gameObject.GetComponent<Rotate>() == false && otherParent.gameObject.GetComponent<BringToFront>() == false && otherParent.gameObject.GetComponent<Canvas>() == false)
			{
			...
			if (otherParent.gameObject.GetComponent<Canvas>() == false)												// Runs if the selected (grand)parent is not a canvas
			{
				...
				else if (otherParent.gameObject.GetComponent<Rotate>() == true)
				{
					includeChildren = otherParent.gameObject.GetComponent<Rotate>().includeChildren;
					bringToFront = otherParent.gameObject.GetComponent<Rotate>().bringToFront;
					bringToFrontOnOver = otherParent.gameObject.GetComponent<Rotate>().bringToFrontOnOver;
					scriptType = "self";
				}
	...
	void Pass ()		// This function is used when the mouse button is not pressed. Mainly for determining which custom cursor should be used currently
	{
		...
		else if (other.gameObject.GetComponent<Rotate>() == true)
		{
			other.gameObject.GetComponent<Rotate>().enabled = true;
			other.gameObject.GetComponent<Rotate>().Passive();
			cursorType = other.gameObject.GetComponent<Rotate>().cursor;
	...
	void Activate ()		// This function is used when the mouse button is initially pressed when over a scripted object
	{
		...
		if (other.gameObject.GetComponent<Rotate>() == true)
		{
			other.gameObject.GetComponent<Rotate>().enabled = true;
			other.gameObject.GetComponent<Rotate>().Active();
		}
		else if (other.gameObject.GetComponent<BringToFront>() == true)
		{
	...
	void End ()			// This function is used when the mouse button is initially released
	{
		...
		if (other.gameObject.GetComponent<Rotate>() == true)
		{
			other.gameObject.GetComponent<Rotate>().End();
			other.gameObject.GetComponent<Rotate>().enabled = false;
		}
