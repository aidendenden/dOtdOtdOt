...
public class MoveParent_1_0 : MonoBehaviour {
	...
	public void MoveObject()										// This function is used to determine the amount of movement of the cursor, and then it moves the object
	{
		...
		transform.parent.position = new Vector2 (Input.mousePosition.x - offsetX, Input.mousePosition.y - offsetY);			// Moves the parent
	}
