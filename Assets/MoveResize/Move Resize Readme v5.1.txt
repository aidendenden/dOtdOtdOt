...
Version 5.1 adds a rotation script by special request.
...
Script Features:
	...
	You have the options to move and resize objects smoothly or by defined intervals. Smooth is the default method, however, the interval method may be desired if using a grid-based system or if you want easier alignment. Not applicable to the Rotate script.
...
The Rotation script rotates an object based on the amount of horizontal mouse movement.
...
For Rotate script:
Simply add the desired script to the object you wish to rotate.
